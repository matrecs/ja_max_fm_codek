...
/obj/item/clothing/mask/cigarette/joint
	name = "Joint"
	desc = "Auw, yeah! So drug, much weed"
	icon_state = "jointoff"
	icon_on = "jointon"                        //TODO: Нарисовать эту мразь
	icon_off = "jointoff"
...
/obj/item/clothing/mask/cigarette/joint/attackby(obj/item/weapon/W as obj, mob/user as mob)
