...
/obj/item/weapon/paper/attackby(obj/item/weapon/P as obj, mob/user as mob)
	...
	if(istype(P, /obj/item/weapon/reagent_containers/food/snacks/grown/ambrosiadeus))
		...
		del(src)
		return
	if(istype(P, /obj/item/weapon/reagent_containers/food/snacks/grown/ambrosiavulgaris))
		new /obj/item/clothing/mask/cigarette/joint(src.loc)
		user.drop_item()
		P.loc = src
		burnpaper(P, user)
		del(src)
