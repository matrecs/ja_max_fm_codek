...
var/station_name = "ERS V-038 'Heretic'"
var/game_version = "Ru Project Heretic"
var/changelog_hash = ""
...
var/CHARGELEVEL = 0.002 // Cap for how fast cells charge, as a percentage-per-tick (.001 means cellcharge is capped to 1% per second)
